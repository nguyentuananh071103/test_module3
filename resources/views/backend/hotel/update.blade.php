                ...
                <div class="card" style="margin-left:50px;">
                    <div class="row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input class="form-control" name="phone" id="inputPassword4" value="{{$hotel->phone}}">
                            @error('phone')
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input class="form-control" name="cccd" id="inputPassword4" value="{{$hotel->cccd}}">
                            @error('cccd')
                            <p style="color: red">{{$message}}</p>
                            @enderror
                        </div>
                        <div class="form-group col-md-6">
                            ...
                            <input class="form-control" name="name" id="inputPassword4" value="{{$hotel->name}}">
                            @error('name')
                            <p style="color: red">{{$message}}</p>
                            @enderror
                        </div>
                        <div class="form-group col-md-6">
                            ...
                            <input class="form-control" name="email" id="inputPassword4" value="{{$hotel->email}}">
                            @error('email')
                            <p style="color: red">{{$message}}</p>
                            @enderror
                        </div>
                        <div class="form-group col-md-6">
                            ...
                            <input class="form-control" name="sex" id="inputPassword4" value="{{$hotel->sex}}">
                            @error('sex')
                            <p style="color: red">{{$message}}</p>
                            @enderror
                        </div>
